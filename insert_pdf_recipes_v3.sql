-- ===========================================================
-- TomaChef Recipe Booklet Import v3
-- UUID-safe and apostrophe-safe: inserts/updates 10 PDF recipes and links them to the 26QT Air Fryer Oven
-- Run after 007_seed_all_data.sql. This version fixes the Supabase error: relation "the" does not exist
-- ===========================================================
...
VALUES (
  ...
  (SELECT id FROM products
   WHERE sku = 'TC-AFO-001'
      OR name ILIKE '%26QT Air Fryer Oven%'
      OR name ILIKE '%26QT%'
   ORDER BY sort_order
   LIMIT 1),
  'Air Fry',
...
-- Verify import
SELECT id, translations->'en'->>'title' as title_en, mode, temp, "time", product_id, image_url, is_active FROM recipes WHERE id IN ('a1b2c3d4-e5f6-4004-8004-000000000004','a1b2c3d4-e5f6-4005-8005-000000000005','a1b2c3d4-e5f6-4006-8006-000000000006','a1b2c3d4-e5f6-4007-8007-000000000007','a1b2c3d4-e5f6-4008-8008-000000000008','a1b2c3d4-e5f6-4009-8009-000000000009','a1b2c3d4-e5f6-4010-8010-000000000010','a1b2c3d4-e5f6-4011-8011-000000000011','a1b2c3d4-e5f6-4012-8012-000000000012','a1b2c3d4-e5f6-4013-8013-000000000013') ORDER BY display_order;
